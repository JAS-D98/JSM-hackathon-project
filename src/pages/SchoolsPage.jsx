...
export default function SchoolsPage() {
  return (
    <div className="px-10 md:px-20">
      <div className="w-full h-[60vh] md:h-[80vh] flex items-center justify-center flex-col">
        <div className='bg-primaryBlueColor w-full rounded-xl text-center p-4 flex flex-col items-center'>
          ...
          <div className='flex flex-row items-center gap-3 flex-wrap justify-center mb-2'>
            <Button title="Kindergarten" backgroundColor="primaryBlueColor" border="border"/>
            <Button title="Primary" backgroundColor="primaryBlueColor" border="border"/>
            <Button title="HighSchool" backgroundColor="primaryBlueColor" border="border"/>
            <Button title="College" backgroundColor="primaryBlueColor" border="border"/>
            <Button title="Univerity" backgroundColor="primaryBlueColor" border="border"/>
          </div>
      ...
      <div>
      <h1 className='text-primaryBlackColor font-bold text-xl md:text-2xl uppercase'>Universities</h1>
      <div className='mt-6 flex flex-col gap-3 md:gap-0 md:flex-row items-center flex-wrap justify-between'>
        ...
        <div className='bg-primaryBlueColor text-primaryWhiteColor w-full md:w-[24%] gap-2 flex flex-col rounded-xl shadow-xl'>
          ...
          <p className='placeholder-opacity-80'>Location: <span className='text-secondaryBlackColor'>Kiharu Murang'a</span></p>
          </div>
        </div>
        <div className='bg-primaryBlueColor text-primaryWhiteColor w-full md:w-[24%] gap-2 flex flex-col rounded-xl shadow-xl'>
          <div className='overflow-hidden w-full h-36 object-cover rounded-tr-xl rounded-tl-xl'>
