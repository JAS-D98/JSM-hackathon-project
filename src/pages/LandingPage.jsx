...
import { aboutimage1, aboutimage2, testimonialParent, testimonialPrincipal, testimonialStudent, testimonialTeacher, wave, waveUp } from '../assets/images';
  ...
  return (
    ...
    <div className='px-20 bg-tertiaryBlueColor'>
      ...
      <div className='w-full md:w-1/2 text-center md:text-start flex flex-col space-y-5 justify-between items-center md:items-start'>
        ...
        <InputSection formAction="" inputPlaceHolder="Search for a school here" btnMarginTop="0" btnTitle="Search School" btnBackground="primaryBlueColor" btnBorder="border" btnfuncWord=""/>
      </div>
    ...
    <img src={wave} alt="image of a wave svg"/>
      ...
      <div className='bg-tertiaryBlueColor flex items-center flex-wrap justify-center gap-2 md:gap-6 px-20'>
          <EvidenceCard icon={<RiCustomerService2Fill />} label="Happy customers" count="1500+"/>
          <EvidenceCard icon={<MdOutlineGroupAdd />} label="Happy customers" count="11500+"/>
          <EvidenceCard icon={<FaHandshakeAngle />} label="Top Partners" count="110+"/>
          <EvidenceCard icon={<FaSchoolFlag />} label="Schools" count="800+"/>
      </div>
      <div className='w-full text-center bg-tertiaryBlueColor pt-6'>
          <h2 className='text-primaryBlueColor  font-bold md:text-4xl uppercase'>What people <span className='text-primaryBlackColor'>say about us</span></h2>
          <p className='text-secondaryBlackColor text-sm md:text-xl mt-2'>Here some amazing testimonials from our esteemed clients</p>
      </div>
      <img src={wave} alt="image of a wave svg"/>
      <div className='flex flex-col md:flex-row items-center px-20 gap-3 mt-4'>
        <div className='w-full md:w-1/2 rounded md:overflow-hidden shadow-primaryBlackColor hover:shadow-primaryBlueColor'>
          <Swiper
            ...
            className="mySwiper bg-primaryBlueColor max-h-96 rounded overflow-hidden"
          >
              <SwiperSlide className='rounded md:max-h-96'><TestimonialCard title="parent" image={testimonialParent} alt="A Parent" name="Mary Anne Wambui" message="This app gave me a platform to have my child enrolled in one of the best schools I could afford."/></SwiperSlide>
              <SwiperSlide className='rounded md:max-h-96'><TestimonialCard title="principal" image={testimonialPrincipal} alt="A Principal" name="Daisy Naiteo" message="Ever since we registered our school in this platform, we have witnessed considerable increase in our students."/></SwiperSlide>
              <SwiperSlide className='rounded md:max-h-96'><TestimonialCard title="student" image={testimonialStudent} alt="A Student" name="Brian Kamau" message="I am really grateful that such an app exists. I can truly attest that I was able to find a great school here."/></SwiperSlide>
              <SwiperSlide className='rounded md:max-h-96'><TestimonialCard title="teacher" image={testimonialTeacher} alt="A Teacher" name="Johnson Ledama" message="This app has given schools and students as well as teachers an opportuunity to make a mark and better learning wholesomely."/></SwiperSlide>
          </Swiper>
        </div>
